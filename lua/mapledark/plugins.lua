...
M.loaders.blinkcmp = function(c)
  -- Popups always have background for visibility
  local bg_popup = c.bg_light
...
M.loaders.fzflua = function(c)
  -- Fzf-lua is a popup, keep background for visibility
  local bg_float = c.bg_light
  hl('FzfLuaNormal', { fg = c.fg, bg = bg_float })
  hl('FzfLuaBorder', { fg = c.border, bg = bg_float })
  hl('FzfLuaTitle', { fg = c.blue, bg = bg_float, bold = true })
  hl('FzfLuaPreviewNormal', { fg = c.fg, bg = bg_float })
  hl('FzfLuaPreviewBorder', { fg = c.border, bg = bg_float })
  hl('FzfLuaPreviewTitle', { fg = c.cyan, bg = bg_float, bold = true })
  hl('FzfLuaCursor', { fg = c.bg, bg = c.blue })  -- Darker fg for AA compliance
  hl('FzfLuaCursorLine', { bg = c.bg_visual })
  hl('FzfLuaCursorLineNr', { fg = c.blue, bg = c.bg_visual, bold = true })
  hl('FzfLuaSearch', { fg = c.bg, bg = c.yellow, bold = true })  -- Darker fg for AA compliance
  hl('FzfLuaScrollBorderEmpty', { fg = bg_float, bg = bg_float })
  hl('FzfLuaScrollBorderFull', { fg = c.border, bg = bg_float })
  hl('FzfLuaScrollFloatEmpty', { fg = bg_float, bg = bg_float })
  hl('FzfLuaScrollFloatFull', { fg = c.border, bg = bg_float })
  hl('FzfLuaHelpNormal', { fg = c.fg, bg = bg_float })
  hl('FzfLuaHelpBorder', { fg = c.border, bg = bg_float })
...
M.loaders.mason = function(c)
  -- Mason is a popup window, keep background for visibility
  local bg_float = c.bg_light
  hl('MasonNormal', { fg = c.fg, bg = bg_float })
  ...
  hl('MasonMutedBlock', { fg = c.fg_dark, bg = bg_float })
  hl('MasonMutedBlockBold', { fg = c.fg_dark, bg = bg_float, bold = true })
...
M.loaders.telescope = function(c)
  -- Telescope is a popup, keep background for visibility
  local bg_float = c.bg_light
  hl('TelescopeBorder', { fg = c.border, bg = bg_float })
  hl('TelescopePromptBorder', { fg = c.border, bg = bg_float })
  hl('TelescopeResultsBorder', { fg = c.border, bg = bg_float })
  hl('TelescopePreviewBorder', { fg = c.border, bg = bg_float })
  ...
  hl('TelescopePreviewNormal', { fg = c.fg, bg = bg_float })
  hl('TelescopeTitle', { fg = c.blue, bg = bg_float, bold = true })
  hl('TelescopePromptTitle', { fg = c.blue, bg = bg_float, bold = true })
  hl('TelescopeResultsTitle', { fg = c.cyan, bg = bg_float, bold = true })
  hl('TelescopePreviewTitle', { fg = c.green, bg = bg_float, bold = true })
end

-- Which-key key binding hints
M.loaders.whichkey = function(c)
  -- Which-key is a popup, keep background for visibility
  local bg_float = c.bg_light
  hl('WhichKey', { fg = c.magenta, bold = true })
  hl('WhichKeyGroup', { fg = c.blue })
  hl('WhichKeyDesc', { fg = c.fg })
  hl('WhichKeySeparator', { fg = c.fg_dark })
  hl('WhichKeyFloat', { fg = c.fg, bg = bg_float })
...
M.loaders.notify = function(c)
  -- Notify is a popup, keep background for visibility
  local bg_float = c.bg_light
  hl('NotifyERRORBorder', { fg = c.red, bg = bg_float })
  hl('NotifyWARNBorder', { fg = c.orange, bg = bg_float })
  hl('NotifyINFOBorder', { fg = c.blue, bg = bg_float })
  hl('NotifyDEBUGBorder', { fg = c.cyan, bg = bg_float })
  hl('NotifyTRACEBorder', { fg = c.magenta, bg = bg_float })
...
M.loaders.noice = function(c)
  -- Noice is a popup, keep background for visibility
  local bg_float = c.bg_light
  hl('NoiceCmdline', { fg = c.fg, bg = bg_float })
  hl('NoiceCmdlineIcon', { fg = c.blue, bg = bg_float })
  hl('NoiceCmdlinePrompt', { fg = c.magenta, bg = bg_float, bold = true })
  hl('NoiceCmdlinePopup', { fg = c.fg, bg = bg_float })
  hl('NoiceCmdlinePopupBorder', { fg = c.border, bg = bg_float })
